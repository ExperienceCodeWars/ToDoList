...
public class TodoController {
    ...
    public String indexPage(Model model) {
        List<ToDoRepr> toDoByUserId = toDoService
                .findToDoByUserId(userService.getCurrentUserId().orElseThrow(ResourceNotFoundException::new));
        model.addAttribute("toDoList", toDoByUserId);
        return "todoList";
    }
